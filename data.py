...
rings = ["Ring of Restraint", "Weapon Jump S Ring", "Weapon Jump I Ring", "Weapon Jump L Ring", "Weapon Jump D Ring", "Ultimatum Ring", "Risk Taker Ring", "Totalling Ring", "Critical Damage Ring",
        ...
        "Reflective Ring", "Ocean Glow Earrings", "Broken Box Piece x5" , "Oz Point Pouch x5", "Whoomp Ticket"]
...
timezones = ["Maple", "Florence", "Frame", "Elliot", "Char"]

categories = ["Online Time", "Streaming Time", "AFK Time", "Reactions Farmed", "Profanities Used", "Messages Sent", "Gambling Winners", "Gambling Losers"]
categoriesDict = {"Streaming Time":"streamTable", "AFK Time":"afkTable","Reactions Farmed":"reactionTable", "Profanities Used":"profanitiesTable", "Messages Sent":"messagesTable", "Times Mentioned": "mentionsTable", "Gambling Winners":"gamblingTable", "Gambling Losers":"gamblingTable"}
...
rewardLinks["Whoomp Ticket"] = "https://static.wikia.nocookie.net/maplestory/images/f/f3/Use_2x_EXP_Coupon.png/revision/latest?cb=20220712230445"

nonRings = ["Ocean Glow Earrings", "Broken Box Piece x5" , "Oz Point Pouch x5", "Whoomp Ticket"]
